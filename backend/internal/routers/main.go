...
func (c *RouteConfig) SetupPublicRoute() {
	...
	v1.GET("/verify", middlewares.AuthenticationMiddleware(c.TokenUtil, constants.ForVerification, constants.VERIFICATION_COOKIE_KEY, constants.CTX_VERIFICATION_PAYLOAD_KEY, constants.CTX_VERIFICATION_TOKEN_KEY), c.StudentHandler.Verify)
	v1.POST("/reset-password/send", c.StudentHandler.SendResetTokenEmail)
	v1.POST("/reset-password/reset", middlewares.AuthenticationMiddleware(c.TokenUtil, constants.ForReset, constants.RESET_COOKIE_KEY, constants.CTX_RESET_PAYLOAD_KEY, constants.CTX_RESET_TOKEN_KEY), c.StudentHandler.ResetPassword)
	...
	v1.GET("/auth/google/verify", middlewares.AuthenticationMiddleware(c.TokenUtil, constants.ForVerification, constants.VERIFICATION_COOKIE_KEY, constants.CTX_VERIFICATION_PAYLOAD_KEY, constants.CTX_VERIFICATION_TOKEN_KEY), c.StudentHandler.GoogleVerify)
